...
import Resume from "../assets/Resume(Ritik Singh) .pdf";
      ...
      <div data-aos="fade-left">
        ...
        >
          <div className="skill-crousel">
            ...
            <p className="skill-desc">5 Star HackerRank, 3000 Points in LeetCode, 450+ questions across plateforms</p>
          </div>
          <div className="skill-crousel">
            <img src={Html} alt="" />
